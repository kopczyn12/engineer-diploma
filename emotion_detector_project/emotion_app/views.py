...
model.load_state_dict(torch.load('/Users/mkopczynski/Desktop/engineer-diploma-final/engineer-diploma/emotion_detector_project/emotion_app/model/convnext.pth', map_location=device))
